...
def main():
    ...
    if geom_type =='1D':
        ...
        plt.plot(freq, mag_G_0_deviation, marker='o')
        plt.xscale('log')
        plt.yscale('log')
        ...
        # Plotting magnitude
        plt.figure(figsize=(8, 6))  # Create a new figure
        plt.plot(omega_plot, mag_G_0_deviation, marker='o')
        plt.xscale('log')
        plt.yscale('log')
...
#        plt.savefig(f'{output_dir}/{case_name}_TRANSFER_DEVIATION/{case_name}_{solver_type.upper()}/{case_name}_{solver_type.upper()}_Diff_Magnitude_freq.png')
#
#        # Plotting phase
#        plt.figure(figsize=(8, 6))  # Create another new figure
...
#        plt.savefig(f'{output_dir}/{case_name}_TRANSFER_DEVIATION/{case_name}_{solver_type.upper()}/{case_name}_{solver_type.upper()}_Diff_Phase_freq.png')
#
