...
D_values = [
    # Mat 1,            Mat 2,             Mat 3,    
    [1/(3*0.570), 1/(3*0.550), 1/(3*0.611)], # G1
    [1/(3*1.100), 1/(3*1.060), 1/(3*2.340)], # G2
]

TOT_values = [
    # Mat 1,    Mat 2,     Mat 3,      
    [0.570, 0.550, 0.611], # G1
    [1.100, 1.060, 2.340], # G2
]

NUFIS_values = [
    # Mat 1,    Mat 2,     Mat 3,      
    [0.5400, 0.0075, 0.5600], # G1
    [0.0200, 0.4500, 0.0500], # G2
]

CHI_values = [
    # Mat 1,      Mat 2,       Mat 3,      
    [1.00000E+00, 1.00000E+00, 1.00000E+00], # G1
    [0.00000E+00, 0.00000E+00, 0.00000E+00], # G2
]

                # Mat 1,   Mat 2,    Mat 3,  
SIGS11_values = [0.540000, 0.520000, 0.560000]
SIGS21_values = [0.000000, 0.000000, 0.000000]

SIGS12_values = [0.020000, 0.015000, 0.050000]
SIGS22_values = [0.760000, 1.000000, 2.300000]

group = len(TOT_values)
...
## INITIALIZATION
case_name = "OBJECTIVES45_TEST15_2DMG_MOX"
