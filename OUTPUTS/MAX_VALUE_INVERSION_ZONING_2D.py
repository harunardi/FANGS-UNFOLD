...
#######################################################################################################
# Load data from JSON file
with open(f'{case_name}/{case_name}_level1_iter15_03_INVERT/{case_name}_level1_iter15_dS_unfold_INVERT_output.json', 'r') as json_file:
    noise_output_C3 = json.load(json_file)
...
########################################################################################################
# Load data from JSON file
with open(f'{case_name}/{case_name}_level1_iter15_04_ZONE/{case_name}_level1_iter15_dS_unfold_ZONE_output.json', 'r') as json_file:
    noise_output_C3 = json.load(json_file)
...
########################################################################################################
# Load data from JSON file
with open(f'{case_name}/{case_name}_level1_iter15_05_SCAN/{case_name}_level1_iter15_dS_SCAN_output.json', 'r') as json_file:
    noise_output_C3 = json.load(json_file)
