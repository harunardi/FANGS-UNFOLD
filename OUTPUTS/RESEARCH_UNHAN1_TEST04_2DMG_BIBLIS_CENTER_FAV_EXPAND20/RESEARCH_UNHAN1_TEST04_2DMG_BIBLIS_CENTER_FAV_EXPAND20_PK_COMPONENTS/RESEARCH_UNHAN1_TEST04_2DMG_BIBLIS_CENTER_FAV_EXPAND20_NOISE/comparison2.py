...
def plot_1D_centerline_y0_2(PHI1g, PHI2g, conv, I_max, J_max, dx, dy, g, varname=None, process_data=None):
    ...
    data = {
        ...
        "flux1_values": flux1_values,
        "flux2_values": flux2_values
    }

    # Save to JSON
    output_path = f"flux{g}_{process_data}.json"
...
from RESEARCH_UNHAN1_TEST04_2DMG_BIBLIS_CENTER_FAV_EXPAND20 import *
