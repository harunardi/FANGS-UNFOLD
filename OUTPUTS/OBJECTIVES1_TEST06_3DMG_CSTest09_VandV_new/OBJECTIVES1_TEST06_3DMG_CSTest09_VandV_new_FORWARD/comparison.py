...
for g in range(group):
    ...
    for k in range(K_max):
        filename_PHI = plot_heatmap_3D(FLX_CORESIM_reshaped[g, k, :, :], g+1, k+1, x, y, cmap='viridis', varname='FLX', title=f'2D Plot of FLX{g+1}, Z={k+1}', case_name=case_name, process_data='magnitude', solve='FORWARD')
