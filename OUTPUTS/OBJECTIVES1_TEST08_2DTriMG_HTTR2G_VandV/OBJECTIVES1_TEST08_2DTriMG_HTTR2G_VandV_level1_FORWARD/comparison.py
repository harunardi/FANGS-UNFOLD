...
from OBJECTIVES1_TEST08_2DTriMG_HTTR2G_VandV import *

os.chdir('../OUTPUTS/OBJECTIVES1_TEST08_2DTriMG_HTTR2G_VandV')
sys.path.append(os.getcwd())

from SPECIAL_PLOT_TRIANGULAR_level1 import *
from SPECIAL_PLOT_TRIANGULAR_level2 import *

os.chdir('OBJECTIVES1_TEST08_2DTriMG_HTTR2G_VandV_level1_FORWARD')
sys.path.append(os.getcwd())
...
FLX_reshaped = [FLX1_normalized, FLX2_normalized]
